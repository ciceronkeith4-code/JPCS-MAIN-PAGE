...
export const officers = [
  ...
  { name: "Khemuel Timkang", role: "Auditor", course: "BSIT · 3rd Year", responsibility: "Maintains transparency and conducts audits for all department activities.", profile_photo: "/officers/timkang_profile.jpg", action_photo: "/officers/timkang_action.jpg" },
  ...
  { name: "John Carl Arche", role: "Technical Head", course: "BSIT · 3rd Year", responsibility: "Directs technical workshops, hands-on bootcamps, and developer support.", profile_photo: "/officers/arche_profile.png", action_photo: "/officers/arche_action.jpg" },
