...
export function HomePage() {
  return (
    <>
      <Seo {...seo.home} />
      <PageHero home eyebrow="IT Department · SSCR Manila" title="Empowering Future Computing Professionals" copy="The IT Department of SSCR Manila is a student-led technology community that develops technical skills, leadership, innovation, and meaningful professional connections." primary="Sign In to Portal" primaryTo="/login" secondary="Explore our community" secondaryTo="/community" imageLabel="IT Department members collaborating" imageFile="home-hero.jpg" />
      ...
      <FullWidthCta eyebrow="Your next chapter" title="Build your skills. Find your community. Shape the future with the IT Department." action="Sign In to Portal" to="/login" imageFile="home-final-cta.webp" />
    </>
  );
}
...
export function CommunityPage() {
  return (
    <>
      ...
      <FullWidthCta eyebrow="Participation creates community" title="Great technology communities are built through participation." action="Sign In to Portal" to="/login" imageFile="community-final-cta.webp" />
    </>
  );
}
...
export function AboutPage() {
  ...
  return (
    <>
      ...
      <FullWidthCta eyebrow="Grow with people beside you" title="You do not have to build your future alone." copy="Learn, lead, collaborate, and grow with the IT Department of SSCR Manila." action="Sign In to Portal" to="/login" imageFile="about-final-cta.webp" />
    </>
  );
}
