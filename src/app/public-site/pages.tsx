...
import { AnimatedButton, benefitIcons, FeatureRow, FullWidthCta, ImagePlaceholder, Reveal, SectionHeading, Seo } from "./components";
import { audienceBenefits, benefits, communityAudiences, homePrograms, memberships, officers, programFeatures, seo, values } from "./data";
...
export function HomePage() {
  return (
    <>
      <Seo {...seo.home} />
      <PageHero home eyebrow="Junior Philippine Computer Society · SSCR Manila" title="Empowering Future Computing Professionals" copy="JPCS–SSCR Manila is a student-led technology community that develops technical skills, leadership, innovation, and meaningful professional connections." primary="Join JPCS" primaryTo="/register" secondary="Explore our community" secondaryTo="/community" imageLabel="JPCS members collaborating" imageFile="home-hero.jpg" />
      ...
      <section className="site-section site-benefits">
        <div className="site-shell"><SectionHeading eyebrow="Growth at every stage" title="JPCS helps students grow with opportunities designed for every stage of their journey." />
      ...
      <section className="site-section site-story">
        <div className="site-shell site-story__grid"><Reveal><ImagePlaceholder label="Chapter adviser or president portrait" file="home-adviser-portrait.webp" /></Reveal><Reveal className="site-story__quote" delay={0.08}><Quote aria-hidden="true" /><blockquote>“JPCS should be the place where students discover that they are capable of more—because they have people beside them, meaningful work in front of them, and room to lead.”</blockquote><p><strong>Name to be confirmed</strong><span>Chapter adviser or president · Placeholder quotation</span></p><AnimatedButton to="/about" variant="text">Meet the chapter</AnimatedButton></Reveal></div>
      </section>
      ...
      <FullWidthCta eyebrow="Your next chapter" title="Build your skills. Find your community. Shape the future with JPCS." action="Join JPCS today" to="/register" imageFile="home-final-cta.webp" />
    </>
  );
}
...
export function ProgramsPage() {
  return (
    <>
      <Seo {...seo.programs} />
      <PageHero eyebrow="JPCS programs" title="Move beyond theory and start building real technical capability." copy="JPCS programs give computing students opportunities to learn, lead, collaborate, compete, and create." primary="View upcoming activities" primaryTo="/community#resources" imageLabel="JPCS workshop or coding event" imageFile="programs-hero.webp" />
      <section className="site-section site-intro" id="page-intro"><div className="site-shell site-intro__grid"><SectionHeading eyebrow="Practice with purpose" title="Practical experiences designed around the needs of computing students." /><Reveal><p>Classroom foundations matter. JPCS adds the situations that make them usable: working with a team, explaining a decision, responding to feedback, and carrying an idea through to a thoughtful result.</p><AnimatedButton to="/community" variant="text">See who takes part</AnimatedButton></Reveal></div></section>
...
export function CommunityPage() {
  return (
    <>
      <Seo {...seo.community} />
      <PageHero eyebrow="The JPCS community" title="A stronger computing community, built around every student." copy="JPCS brings students, officers, educators, alumni, and industry partners together through shared learning and meaningful experiences." primary="Become part of JPCS" primaryTo="/register" imageLabel="JPCS chapter community" imageFile="community-hero.webp" />
      ...
      <section className="site-section site-learning" id="resources"><div className="site-shell site-learning__grid"><Reveal><span className="site-eyebrow">Shared learning</span><h2>Speak the same language of innovation, leadership, and service.</h2><p>JPCS creates a connected technology community by giving students, educators, alumni, and partners a shared place to exchange knowledge and build things that matter.</p><a className="site-resource-link" href="/JPCS-membership-guide-placeholder.md" download><Download aria-hidden="true" /><span>View JPCS resources<small>Placeholder guide · replace when official details are available</small></span><ExternalLink aria-hidden="true" /></a></Reveal><Reveal delay={0.1}><ImagePlaceholder label="Shared learning and resources image" file="community-resources.webp" /></Reveal></div></section>
      <FullWidthCta eyebrow="Participation creates community" title="Great technology communities are built through participation." action="Become part of JPCS" to="/register" imageFile="community-final-cta.webp" />
    </>
  );
}
...
export function AboutPage() {
  ...
  return (
    <>
      <Seo {...seo.about} />
      <PageHero eyebrow="About the chapter" title="A student organization built to help future computing professionals thrive." copy="JPCS–SSCR Manila creates opportunities for students to strengthen technical skills, develop leadership, build meaningful connections, and serve the wider community." primary="Join the chapter" primaryTo="/register" imageLabel="Atmospheric JPCS chapter collage" imageFile="about-hero.webp" />
      <section className="site-section site-why" id="page-intro"><div className="site-shell"><SectionHeading eyebrow="The need we answer" title="Why JPCS exists" />
      ...
      <section className="site-statement"><div className="site-shell"><Reveal><span className="site-eyebrow">Our role</span><h2>Students need a community that connects technical learning, leadership, professional development, and service. <em>That is the role of JPCS.</em></h2></Reveal></div></section>
