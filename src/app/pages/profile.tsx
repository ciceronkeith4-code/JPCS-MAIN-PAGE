  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <Card className="p-6 bg-white border border-slate-200 rounded-xl shadow-2xs">
        ...
        {/* Account Details & Password Forms Stacked Minimalist Style */}
        <div className="space-y-8 pt-6">
          ...
          <div className="border-t border-slate-100 pt-6">
            <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-4">Security & Password</h3>
            <form onSubmit={handlePasswordSave} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <Input label="Current Password" type="password" placeholder="Enter current password" value={pwForm.current} onChange={(e) => setPwForm((f) => ({ ...f, current: e.target.value }))} />
                <Input label="New Password" type="password" placeholder="Minimum 8 characters" value={pwForm.next} onChange={(e) => setPwForm((f) => ({ ...f, next: e.target.value }))} />
                <Input label="Confirm New Password" type="password" placeholder="Re-enter new password" value={pwForm.confirm} onChange={(e) => setPwForm((f) => ({ ...f, confirm: e.target.value }))} />
              </div>
              <div className="flex justify-end pt-2">
